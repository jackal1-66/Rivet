...
Title=Differential cross section for prompt $D^+$ production ($|y|<0.5$).
XLabel=$p_T$ [GeV/c]
YLabel=$\frac{\text{d}\sigma}{\text{d}p_T}$ [$\mu$b/GeV]
ConnectBins=0
LegendXPos=0.45
...
Title=Differential cross section for prompt $D_{s}^+$ production ($|y|<0.5$).
XLabel=$p_T$ [GeV/c]
YLabel=$\frac{\text{d}\sigma}{\text{d}p_T}$ [$\mu$b/GeV]
ConnectBins=0
LegendYPos=0.95
...
Title=Ratio of $D^+$ to $D^0$ meson yield ($|y|<0.5$). 
XLabel= $p_T$ [GeV/c]
...
Title=Ratio of $D_s^+$ to $D^0$ meson yield ($|y|<0.5$). 
XLabel= $p_T$ [GeV/c]
...
Title=Ratio of $D_s^+$ to $D^+$ meson yield ($|y|<0.5$). 
XLabel= $p_T$ [GeV/c]
...
Title=Integrated cross sections for prompt $c\overline{c}$ production ($|y|<0.5$). 
XLabel= $E$ = 7 TeV
YLabel=$\frac{\text{d}\sigma}{\text{d}y}$ [$\mu$b]
ConnectBins=0
LegendYPos=0.95
...
Title=Mean $p_T$ of prompt $D^0$ ($|y|<0.5$). 
XLabel= $E$ = 7 TeV
