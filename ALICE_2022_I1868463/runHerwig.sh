...
Herwig run LHC-MBDefault.run &>$WD/Herwig1e6SOFTDef.log &
Herwig run LHC-MB_CRPlain.run &>$WD/Herwig1e6CRPlain.log &
Herwig run LHC-MB_CRBaryonicRec.run &>$WD/Herwig1e6CRBaryonicRec.log &
cd $WD
